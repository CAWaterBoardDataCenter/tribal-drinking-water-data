...
The U.S. Department of the Interior, Bureau of Indian Affairs' (BIA) Land Area Representations (LAR) dataset is available for download at [this link](https://biamaps.doi.gov/bogs/datadownload.html#H2T2). The data displayed in this tool comes from a copy of the dataset we downloaded in February 2022. 
...
Tabular data (DHS mobile home parks within CA tribal boundaries):
...
The datasets listed below were some that we identified as part of our exploratory analysis; not all of them were ultimately used for analysis/app.
